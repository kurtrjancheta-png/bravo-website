...
export default async function CellphoneScannerPage() {
  let sheet1Data = [];
  let cl2Data = [];
  let cl3Data = [];
  let cl4Data = [];
  ...
  return (
    <div>
      <div className="section-header" style={{ marginBottom: '2rem' }}>
        <h2 className="section-title">SMARTPHONE QR SCANNER</h2>
        <div className="section-subtitle">S6 Officer rapid scanning and status terminal</div>
      </div>
      
      {parsedData.length > 0 ? (
        <ScannerClient initialData={parsedData} />
      ) : (
